...
## Code
FedAPA Code is available at:  [FedAPA Code](https://github.com/saxdsb/FedAPA)

## Convergence Analysis
To access our proof of convergence, visit: [Convergence Analysis](https://github.com/Yuxia-Sun/FedAPA/blob/main/FedAPA_pf_cvg.pdf)
